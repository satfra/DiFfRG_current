...
#include "VPolyakov.hh"
#include "VPolyakov.kernel"

namespace DiFfRG
{
  namespace Flows
  {
    VPolyakov_integrator::VPolyakov_integrator(QuadratureProvider &quadrature_provider, std::array<uint, 1> grid_sizes, const double x_extent, const JSONValue &json)
    ...
    {
      integrator = std::make_unique<DiFfRG::IntegratorTBB<3, double, VPolyakov_kernel<__REGULATOR__>>>(quadrature_provider, grid_sizes, x_extent, json);
      for (uint i = 0; i < 1; ++i)
        jac_grid_sizes[i] = uint(jacobian_quadrature_factor * grid_sizes[i]);
      integrator_AD = std::make_unique<DiFfRG::IntegratorTBB<3, autodiff::real, VPolyakov_kernel<__REGULATOR__>>>(quadrature_provider, jac_grid_sizes, x_extent, json);
    }

    VPolyakov_integrator::VPolyakov_integrator(const VPolyakov_integrator &other)
        : quadrature_provider(other.quadrature_provider), grid_sizes(other.grid_sizes), jac_grid_sizes(other.jac_grid_sizes), x_extent(other.x_extent),
          ...
          integrator(std::make_unique<DiFfRG::IntegratorTBB<3, double, VPolyakov_kernel<__REGULATOR__>>>(other.quadrature_provider, other.grid_sizes, other.x_extent, other.json)),
          integrator_AD(std::make_unique<DiFfRG::IntegratorTBB<3, autodiff::real, VPolyakov_kernel<__REGULATOR__>>>(other.quadrature_provider, other.jac_grid_sizes, other.x_extent,
                                                                                                                    other.json))
    {
    }

    VPolyakov_integrator::~VPolyakov_integrator() = default;

    std::future<double> VPolyakov_integrator::request_CT(const double k, const double p0f, const double p, const double T, const double muq, const double A0, const double gAqbq1,
    ...
    double VPolyakov_integrator::get_CT(const double k, const double p0f, const double p, const double T, const double muq, const double A0, const double gAqbq1, const double etaQ,
    ...
    std::future<autodiff::real> VPolyakov_integrator::request_AD(const double k, const double p0f, const double p, const double T, const double muq, const double A0,
                                                                 const double gAqbq1, const autodiff::real etaQ, const autodiff::real etaPhi, const autodiff::real etaQ0,
                                                                 const autodiff::real etaPhi0, const autodiff::real detaPhi0, const autodiff::real hPhi,
                                                                 const autodiff::real d1hPhi, const autodiff::real d2V, const autodiff::real d3V, const double rhoPhi,
                                                                 const autodiff::real m2Pion, const autodiff::real m2Sigma)
    {
    ...
    autodiff::real VPolyakov_integrator::get_AD(const double k, const double p0f, const double p, const double T, const double muq, const double A0, const double gAqbq1,
