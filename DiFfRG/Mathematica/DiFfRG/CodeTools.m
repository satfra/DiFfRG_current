(*::Package::*)
    ...
    (***********************************************************************
         *)(*This file was generated automatically by the Mathematica front
                 end.*)(*It contains Initialization cells from a Notebook file,
                        which *)(*typically will have the same name as this file except ending in *)(*".nb" instead of
                                                                                                      ".m".*)(
            **)(*This file is intended to be loaded into the Mathematica
                    kernel using *)(*the package loading commands Get or
                                    Needs.Doing so is equivalent *)(*to using the Evaluate Initialization Cells menu
                                                                        command in the front *)(*end.*)(
            **)(*DO NOT EDIT THIS FILE.This entire file is regenerated
                     *)(*automatically each time the parent Notebook file is saved in the
                            *)(*Mathematica front end.Any changes you make to this file will be *)(*overwritten.*)(
            ************************************************************************)
...
(*::Input::Initialization::*)flowName = "flows";
...
integrators=Map[
{
  StringSplit[#, "/"][[-1]], StringSplit[#, "/"][[-1]] < > "_integrator",
      "./" < > StringSplit[#, "/"][[-1]] < > "/" < > StringSplit[#, "/"][[-1]] < > ".hh"}&
,folders];
...
"Includes"->{"./flows.hh"},
"Body"->{
  FunKit`MakeCppFunction["Name"->varName, "Class"->varName, "Suffix"->integratorInitializations, "Body"->"",
                         "Parameters"->{
                             <| "Type"->"DiFfRG::JSONValue", "Reference"->True, "Const"->True, "Name"->"json" |>},
                         "Return"->""],
      FunKit`MakeCppFunction
          ["Name"->"set_k", "Class"->varName,
           "Parameters"->{<| "Type"->"double", "Const"->True, "Name"->"k", "Reference"->False |>},
           "Body"->StringJoin
               [Map["
                    if constexpr (DiFfRG::has_set_k<decltype("<>#[[1]]<>".integrator)>) "<>#[[1]]<>".integrator.set_k(
                        k);
                    if constexpr (DiFfRG::has_integrator_AD<decltype("<>#[[1]]<>")>) if constexpr (
                        DiFfRG::has_set_k<decltype("<>#[[1]]<>".integrator_AD)>) "<>#[[1]]<>".integrator_AD.set_k(k);
                    "<>" if constexpr (DiFfRG::has_set_T<decltype("<>#[[1]]<>".integrator)>) "<>#[[1]]<>".integrator
                        .set_T(k);
                    if constexpr (DiFfRG::has_integrator_AD<decltype("<>#[[1]]<>")>) if constexpr (
                        DiFfRG::has_set_T<decltype("<>#[[1]]<>".integrator_AD)>) "<>#[[1]]<>".integrator_AD.set_T(k);
                    "
                        &,
                    integrators]],
           "Return"->"void"]
...
paramsAD[[i]]=KeyDrop[paramsAD[[i]],{"Type"}];paramsAD[[i]]=Association[Normal@(paramsAD[[i]])\[Union]{
  "Type"->explParamAD}];
];
           ...
           "MembersPublic"
               ->Join[{
                 FunKit`MakeCppFunction["Name"->spec["Name"] < > "_integrator",
                                        "Parameters"->{<| "Type"->"DiFfRG::QuadratureProvider", "Reference"->True,
                                                        "Const"->False, "Name"->"quadrature_provider" |>,
                                                       <| "Type"->"DiFfRG::JSONValue", "Reference"->True, "Const"->True,
                                                        "Name"->"json" |>},
                                        "Body"->None, "Return"->""],
                     If[Length[coordinates] > 0,
                        FunKit`MakeCppFunction["Name"->"map", "Templates"->{"NT=double"}, "Parameters"->{tparams},
                                               "Body"->"static_assert(std::is_same_v<NT, double> || std::is_same_v<NT, "
                                                       "autodiff::real>, \"Unknown type requested of " < >
                     ...
                     If[spec["AD"], spec["Integrator"] < > "<" < > integratorADTemplateParams < > "> integrator_AD;",
                      ...
                      Map[FunKit`MakeCppFunction["Name"->"map", "Return"->"void", "Body"->None,
                                                 "Parameters"->Join[{
<|"Name"->"dest","Type"->"double*","Const"->False|>,<|"Name"->"coordinates","Reference"->True,"Type"->#,"Const"->True|>
                                                 },
                                                                    params]] &,
                          coordinates],
                      If[spec["AD"], #, {}] & @Map[FunKit`MakeCppFunction["Name"->"map", "Return"->"void", "Body"->None,
                                                                          "Parameters"->Join[{
<|"Name"->"dest","Type"->"autodiff::real*","Const"->False|>,<|"Name"->"coordinates","Reference"->True,"Type"->#,"Const"->True|>
                                                                          },
                                                                                             paramsAD]] &,
                                                   coordinates],
                      {FunKit`MakeCppFunction["Name"->"get", "Return"->"void", "Body"->None,
                                              "Parameters"->Join[{<| "Name"->"dest", "Type"->"double",
...
"Includes"->{"../"<>spec["Name"]<>".hh"},
"Body"->{
  FunKit`MakeCppFunction["Name"->"map", "Return"->"void", "Class"->spec["Name"] < > "_integrator",
                         "Body"->"integrator.map(dest, coordinates, " < > arguments < > ");",
                         "Parameters"->Join[{<| "Name"->"dest", "Type"->"double*", "Const"->False |>,
                                             <| "Name"->"coordinates", "Reference"->True, "Type"->#, "Const"->True |>},
                                            params]]
}]&,coordinates];
...
"Body"->{
  FunKit`MakeCppFunction["Name"->"map", "Return"->"void", "Class"->spec["Name"] < > "_integrator",
                         ...
                         "Parameters"->Join[{<| "Name"->"dest", "Type"->"autodiff::real*", "Const"->False |>,
                                             <| "Name"->"coordinates", "Reference"->True, "Type"->#, "Const"->True |>},
                                            paramsAD]]
}]&,coordinates];
(*Print["\n-----------------------------\n"];
