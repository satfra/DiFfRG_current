...
(FunKit`dressing[FunKit`GammaN, {A, A, A}, 1, {p1, l1 - p1, -l1}]*
  ...
  FunKit`dressing[FunKit`GammaN, {A, A, A, A}, 1, 
   {-p1, p2, l1 - p2, -l1 + p1}]*FunKit`dressing[FunKit`Rdot, {A, A}, 1, 
   ...
   sp[l1, l1]^3*(sp[l1, p2]^2*sp[p1, p1]*(2*sp[p1, p2]^2 + 
     ...
     sp[p2, p2]*(-(sp[l1, p1]^2*(2*sp[p1, p2]^2 + 5*sp[p1, p1]*sp[p2, p2])) - 
       sp[l1, p1]*(-9*sp[p1, p2]^3 + 12*sp[p1, p1]^2*sp[p2, p2] + 
         sp[p1, p1]*sp[p1, p2]*(22*sp[p1, p2] + 27*sp[p2, p2])) + 
     ...
     sp[l1, p1]^2*(sp[l1, p2]^3*(sp[p1, p2]^2 + sp[p1, p1]*
        ...
        (-5*sp[p1, p2]^3*(sp[p1, p2] - 2*sp[p2, p2]) + 
         ...
         sp[p1, p1]*sp[p1, p2]*(5*sp[p1, p2]^2 - 15*sp[p1, p2]*sp[p2, p2] - 
           6*sp[p2, p2]^2)) + sp[l1, p2]^2*(32*sp[p1, p1]^2*sp[p2, p2] - 
         sp[p1, p2]^2*(26*sp[p1, p2] + 9*sp[p2, p2]) + 
         sp[p1, p1]*(-9*sp[p1, p2]^2 + 16*sp[p1, p2]*sp[p2, p2] + 
           32*sp[p2, p2]^2)) + sp[l1, p2]*
        (sp[p1, p2]^3*(5*sp[p1, p2] - 7*sp[p2, p2]) - sp[p1, p1]^2*sp[p2, p2]*
          (5*sp[p1, p2] + 132*sp[p2, p2]) + sp[p1, p1]*(5*sp[p1, p2]^3 + 
           18*sp[p1, p2]^2*sp[p2, p2] + 13*sp[p1, p2]*sp[p2, p2]^2 - 
           17*sp[p2, p2]^3)))) - sp[l1, l1]^2*(sp[l1, p2]^4*sp[p1, p1]^2 + 
