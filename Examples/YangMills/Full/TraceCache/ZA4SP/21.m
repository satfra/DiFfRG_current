...
(FunKit`dressing[FunKit`GammaN, {A, cb, c}, 1, {p1, lf1 - p1, -lf1}]*
  ...
  (9*cos[p2, lf1]^2*sp[lf1, lf1] - 
   9*(3*cos[p1, lf1]^4 + 3*cos[p1, lf1]^3*(3*cos[p2, lf1] + cos[p3, lf1]) + 
    ...
    (9*sp[lf1, lf1] - 43*sp[p, p]) + 12*(-cos[p2, lf1] + cos[p3, lf1])*
   ...
   2*cos[p1, lf1]*(cos[p2, lf1]*(18*sp[lf1, lf1] - 17*sp[p, p]) - 
