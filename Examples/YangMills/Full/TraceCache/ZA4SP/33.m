...
-1/1176*(FunKit`dressing[FunKit`GammaN, {A, cb, c}, 1, {p1, -lf1, lf1 - p1}]*
   FunKit`dressing[FunKit`GammaN, {A, cb, c}, 1, {p2, -lf1 - p2 - p3, 
     lf1 + p3}]*FunKit`dressing[FunKit`GammaN, {A, cb, c}, 1, 
    {-p1 - p2 - p3, -lf1 + p1, lf1 + p2 + p3}]*FunKit`dressing[FunKit`GammaN, 
    {A, cb, c}, 1, {p3, -lf1 - p3, lf1}]*FunKit`dressing[FunKit`Rdot, 
    ...
    12*(cos[p1, lf1] + 2*cos[p2, lf1] + cos[p3, lf1])*Sqrt[sp[lf1, lf1]]*
     Sqrt[sp[p, p]] - 3*(6*cos[p1, lf1]^3 + cos[p1, lf1]^2*
       (21*cos[p2, lf1] + 23*cos[p3, lf1]) + cos[p1, lf1]*
       (3*cos[p2, lf1]^2 + 52*cos[p2, lf1]*cos[p3, lf1] + 
    ...
    3*cos[p2, lf1]^2*(-3*sp[lf1, lf1] + sp[p, p]) + 
