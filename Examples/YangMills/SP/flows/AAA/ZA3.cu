...
namespace DiFfRG
{
  namespace Flows
  {
    ZA3_integrator::ZA3_integrator(QuadratureProvider &quadrature_provider, std::array<uint, 3> grid_sizes,
    ...
    {
      integrator = std::make_unique<DiFfRG::Integrator4D2AngGPU<double, ZA3_kernel<__REGULATOR__>>>(
    ...
    double ZA3_integrator::get_CT(const double k, const double p,
