...
#include <DiFfRG/physics/integration/integrator_2Dpx0_gpu.hh>
...
TEST_CASE("Test 2Dpx0 gpu momentum integrals", "[2Dpx0 integration][quadrature integration]")
{
  constexpr int dim = 3;
  ...
  Integrator2Dpx0GPU<double, PolyIntegrand> integrator(quadrature_provider, {{32, 12, 12}}, x_extent, x0_extent);
