                       ...
                       ((int dim), dim), (2), (3), (4))
{
  ...
  IntegratorFiniteTq0GPU<dim, double, PolyIntegrand> integrator(quadrature_provider, {{64, 12}}, x_extent, q0_extent,
                                                                q0_summands, T);
  ...
  {
    IntegratorFiniteTq0TBB<dim, double, PolyIntegrand> integrator_cpu(quadrature_provider, {{64, 12}}, x_extent,
