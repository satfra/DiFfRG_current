...
namespace DiFfRG
{
  namespace Flows
  {
    etaQ_integrator::etaQ_integrator(QuadratureProvider &quadrature_provider, std::array<uint, 3> grid_sizes, const double x_extent, const double q0_extent, const uint q0_summands,
    ...
    {
      integrator =
          std::make_unique<DiFfRG::IntegratorAngleFiniteTq0TBB<4, double, etaQ_kernel<__REGULATOR__>>>(quadrature_provider, grid_sizes, x_extent, q0_extent, q0_summands, json);
      for (uint i = 0; i < 3; ++i)
        jac_grid_sizes[i] = uint(jacobian_quadrature_factor * grid_sizes[i]);
      integrator_AD = std::make_unique<DiFfRG::IntegratorAngleFiniteTq0TBB<4, autodiff::real, etaQ_kernel<__REGULATOR__>>>(quadrature_provider, jac_grid_sizes, x_extent, q0_extent,
                                                                                                                           q0_summands, json);
    }
    ...
    etaQ_integrator::etaQ_integrator(const etaQ_integrator &other)
        : quadrature_provider(other.quadrature_provider), grid_sizes(other.grid_sizes), jac_grid_sizes(other.jac_grid_sizes), x_extent(other.x_extent), q0_extent(other.q0_extent),
          ...
          integrator(std::make_unique<DiFfRG::IntegratorAngleFiniteTq0TBB<4, double, etaQ_kernel<__REGULATOR__>>>(other.quadrature_provider, other.grid_sizes, other.x_extent,
                                                                                                                  other.q0_extent, other.q0_summands, other.json)),
          integrator_AD(std::make_unique<DiFfRG::IntegratorAngleFiniteTq0TBB<4, autodiff::real, etaQ_kernel<__REGULATOR__>>>(
    ...
    void etaQ_integrator::set_T(const double value)
    {
      integrator->set_T(value);
      integrator_AD->set_T(value);
    }
    void etaQ_integrator::set_q0_extent(const double value)
    {
      integrator->set_q0_extent(value);
      integrator_AD->set_q0_extent(value);
    }

    std::future<double> etaQ_integrator::request_CT(const double k, const double p0f, const double p, const double Nc, const double Nf, const double T, const double muq,
    ...
    double etaQ_integrator::get_CT(const double k, const double p0f, const double p, const double Nc, const double Nf, const double T, const double muq, const double etaQ,
    ...
    std::future<autodiff::real> etaQ_integrator::request_AD(const double k, const double p0f, const double p, const double Nc, const double Nf, const double T, const double muq,
    ...
    autodiff::real etaQ_integrator::get_AD(const double k, const double p0f, const double p, const double Nc, const double Nf, const double T, const double muq,
