...
DiFfRG::Integrator_p2<3, autodiff::real, V_kernel<Regulator>, DiFfRG::TBB_exec> integrator_AD;
 ...
 void get(double& dest, const double& k, const double& Nf, const double& T, const double& m2Pi, const double& m2Sigma)
;
...
device::apply([&](const auto...t){get(dest, t...);}, args);
 ...
 void get(autodiff::real& dest, const double& k, const double& Nf, const double& T, const autodiff::real& m2Pi, const autodiff::real& m2Sigma)
