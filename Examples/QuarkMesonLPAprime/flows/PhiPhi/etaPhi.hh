...
namespace DiFfRG
{
  namespace Flows
  {
    ...
    {
    public:
      etaPhi_integrator(QuadratureProvider &quadrature_provider, std::array<uint, 3> grid_sizes, const double x_extent, const double q0_extent, const uint q0_summands,
      ...
      {
        static_assert(std::is_same_v<NT, double> || std::is_same_v<NT, autodiff::real>, "Unknown type requested of etaPhi_integrator::request");
    ...
    private:
      ...
      std::unique_ptr<DiFfRG::IntegratorAngleFiniteTq0TBB<4, autodiff::real, etaPhi_kernel<__REGULATOR__>>> integrator_AD;
    };
  } // namespace Flows
} // namespace DiFfRG