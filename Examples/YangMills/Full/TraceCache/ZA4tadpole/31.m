...
(FunKit`dressing[FunKit`GammaN, {A, A, A}, 1, {-p1, l1 + p1, -l1}]*
  ...
  FunKit`dressing[FunKit`GammaN, {A, A, A, A}, 1, 
   ...
   sp[l1, l1]^2*(sp[l1, p2]^4*sp[p1, p1]^2 + sp[l1, p1]^4*sp[p2, p2]^2 + 
     ...
     sp[l1, p1]*(45*sp[p1, p1]^3*sp[p2, p2]^2 + sp[p1, p2]^3*
        (-8*sp[p1, p2]^2 - 8*sp[p1, p2]*sp[p2, p2] + 5*sp[p2, p2]^2) + 
       sp[p1, p1]^2*sp[p2, p2]*(-110*sp[p1, p2]^2 + 83*sp[p1, p2]*
          sp[p2, p2] + 36*sp[p2, p2]^2) + sp[p1, p1]*sp[p1, p2]*
        (31*sp[p1, p2]^3 + 13*sp[p1, p2]^2*sp[p2, p2] + 
     ...
     sp[l1, p2]*(2*sp[l1, p1]^3*sp[p1, p2]*sp[p2, p2] - 
       ...
       sp[l1, p1]*(sp[p1, p2]^3*(17*sp[p1, p2] + 7*sp[p2, p2]) + 
         sp[p1, p1]^2*sp[p2, p2]*(69*sp[p1, p2] + 29*sp[p2, p2]) + 
         sp[p1, p1]*sp[p1, p2]*(-13*sp[p1, p2]^2 + 58*sp[p1, p2]*sp[p2, p2] - 
           41*sp[p2, p2]^2)) + sp[p1, p1]*(3*sp[p1, p1]^2*sp[p2, p2]*
          (10*sp[p1, p2] + 19*sp[p2, p2]) + sp[p1, p2]^2*(19*sp[p1, p2]^2 - 
   ...
   sp[l1, l1]*(3*sp[l1, p1]^5*sp[p2, p2]^2 - sp[l1, p1]^4*sp[p2, p2]*
     ...
     sp[p1, p1]*(-(sp[l1, p2]^5*sp[p1, p1]) + 5*sp[p1, p2]^5*
       ...
       sp[l1, p2]^3*(sp[p1, p1]^2*(6*sp[p1, p2] - 3*sp[p2, p2]) + 
         5*sp[p1, p2]^2*(-2*sp[p1, p2] + sp[p2, p2]) - 
     ...
     sp[l1, p1]^2*(-15*sp[p1, p1]^3*sp[p2, p2]^2 + 
       sp[p1, p2]^3*(12*sp[p1, p2]^2 + 11*sp[p1, p2]*sp[p2, p2] - 
         10*sp[p2, p2]^2) + 6*sp[p1, p1]^2*sp[p2, p2]*(16*sp[p1, p2]^2 - 
         3*sp[p1, p2]*sp[p2, p2] + 4*sp[p2, p2]^2) - sp[p1, p1]*sp[p1, p2]*
        (18*sp[p1, p2]^3 + 54*sp[p1, p2]^2*sp[p2, p2] + 
         75*sp[p1, p2]*sp[p2, p2]^2 - 37*sp[p2, p2]^3) + 
       sp[l1, p2]^3*(sp[p1, p2]^2 + sp[p1, p1]*(6*sp[p1, p2] + sp[p2, p2])) + 
       sp[l1, p2]^2*(sp[p1, p2]^2*(13*sp[p1, p2] - 9*sp[p2, p2]) - 
         59*sp[p1, p1]^2*sp[p2, p2] + sp[p1, p1]*(42*sp[p1, p2]^2 + 
     ...
     sp[l1, p1]*(sp[l1, p2]^4*sp[p1, p1]*(3*sp[p1, p1] + 2*sp[p1, p2]) + 
       sp[l1, p2]^3*(5*sp[p1, p2]^3 + 2*sp[p1, p1]^2*(8*sp[p1, p2] - 
           3*sp[p2, p2]) + 11*sp[p1, p1]*sp[p1, p2]*(3*sp[p1, p2] - 
           sp[p2, p2])) + 5*sp[p1, p2]^5*(sp[p1, p2] - sp[p2, p2]) + 
       45*sp[p1, p1]^4*sp[p2, p2]^2 + sp[p1, p1]*sp[p1, p2]^3*
       ...
       sp[p1, p1]^3*sp[p2, p2]*(-80*sp[p1, p2]^2 + 19*sp[p1, p2]*sp[p2, p2] + 
        ...
        (5*sp[p1, p2]^4*(2*sp[p1, p2] - sp[p2, p2]) + 
         sp[p1, p1]^3*(11*sp[p1, p2] - 97*sp[p2, p2])*sp[p2, p2] + 
   ...
   sp[l1, p1]*(-2*sp[l1, p1]^5*sp[p2, p2]^2 + sp[l1, p1]^4*sp[p2, p2]*
     ...
     sp[l1, p1]^2*(45*sp[p1, p1]^3*sp[p2, p2]^2 + 4*sp[p1, p2]^4*
