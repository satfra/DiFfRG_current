...
namespace DiFfRG
{
  ...
  public:
           ...
           const SplineInterpolator1D<double, FocusedLogCoordinates1D<double>> &ZA)
    {
      ...
      return fma(-3.,
                 _den3 * _den5 * powr<2>(_interp4) * (-1. + powr<2>(cos1)) *
                     (_interp2 * _interp7 + _interp6 * (_interp11 + 50. * _den1 * (_interp12 - _interp2) * powr<6>(k))),
                 fma(-3.,
                     _den2 * _den4 * _den6 * powr<2>(_interp4) *
                         (_interp5 * _interp6 + _interp7 * _interp8 + _interp6 * (-50. * _interp8 + 50. * _interp9)) *
