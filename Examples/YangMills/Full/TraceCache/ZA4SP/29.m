...
(FunKit`dressing[FunKit`GammaN, {A, cb, c}, 1, {p1, lf1 - p1 - p2 - p3, 
   ...
   {p2, lf1 - p2 - p3, -lf1 + p3}]*FunKit`dressing[FunKit`GammaN, {A, cb, c}, 
  ...
  (9*cos[p1, lf1]^2*sp[lf1, lf1] - 
   ...
   3*(6*cos[p1, lf1]^3 - 18*cos[p2, lf1]^3 - 7*cos[p2, lf1]^2*cos[p3, lf1] + 
     17*cos[p2, lf1]*cos[p3, lf1]^2 + 12*cos[p3, lf1]^3 - 
   ...
   2*cos[p1, lf1]*(3*cos[p2, lf1]*(3*sp[lf1, lf1] + sp[p, p]) + 
     cos[p3, lf1]*(-18*sp[lf1, lf1] + 17*sp[p, p]))))/
