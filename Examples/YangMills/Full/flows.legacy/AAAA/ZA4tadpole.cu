...
namespace DiFfRG
{
  namespace Flows
  {
    ZA4tadpole_integrator::ZA4tadpole_integrator(QuadratureProvider &quadrature_provider, std::array<uint, 3> grid_sizes, const double x_extent, const JSONValue &json)
