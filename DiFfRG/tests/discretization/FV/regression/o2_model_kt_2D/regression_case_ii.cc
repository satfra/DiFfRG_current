...
namespace
{
  ...
  class O2_Model_VI_B_II : public def::AbstractModel<O2_Model_VI_B_II, Components>,
                           public def::fRG,
                           public def::LLFFlux<O2_Model_VI_B_II>,
                           public def::FlowBoundaries<O2_Model_VI_B_II>,
                           public def::FVDefaultBoundaries<O2_Model_VI_B_II>,
                           public def::AD<O2_Model_VI_B_II>
  {
  public:
    O2_Model_VI_B_II() : def::fRG(1.0) {}
    explicit O2_Model_VI_B_II(const JSONValue &json) : def::fRG(json) {}
  ...
  using O2Assembler = FV::KurganovTadmor::Assembler<Discretization, O2_Model_VI_B_II, Reconstructor>;
