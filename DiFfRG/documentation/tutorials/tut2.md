(tut2)=
# Tutorial 2: A Quark-Meson model in LPA
...
Setting up the application is analogeous to [Tutorial 1](tut1.md), i.e. you create all files and their contents just as there, renaming all instances of `tut1` to `tut2`.
