...
#include <DiFfRG/physics/integration/integrator_3D_cartesian_gpu.hh>
...
TEST_CASE("Test 3d cartesian gpu momentum integrals", "[integration][quadrature integration]")
{
  ...
  Integrator3DCartesianGPU<double, PolyIntegrand> integrator(quadrature_provider, {{32, 32, 32}}, 0., 256, qx_min,
