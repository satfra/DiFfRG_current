...
namespace DiFfRG::Config
{
  ...
  EoMConfig::EoMConfig(const JSONValue &json)
      : EoMConfig(json.get_double("/discretization/EoM_abs_tol", default_abs_tol),
                  json.get_uint("/discretization/EoM_max_iter", default_max_iter),
                  json.get_double("/discretization/EoM_smoothing_length", default_smoothing_length),
                  json.get_double("/discretization/EoM_bound_tolerance", default_bound_tolerance),
                  json.get_double("/discretization/EoM_armijo_coefficient", default_armijo_coefficient),
                  json.get_uint("/discretization/EoM_max_backtracks", default_max_backtracks))
  {
  }
