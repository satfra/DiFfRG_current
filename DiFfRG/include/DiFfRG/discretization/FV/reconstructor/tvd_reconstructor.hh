...
namespace DiFfRG
{
  namespace def
  {
     ...
     *     Discretization, Model, def::TVDReconstructor<def::MinModLimiter>>;
     * @endcode
     */
    template <HasSlopeLimiter Limiter> class TVDReconstructor
    {
    public:
      /**
    ...
    static_assert(HasReconstructor<TVDReconstructor<MinModLimiter>>);
