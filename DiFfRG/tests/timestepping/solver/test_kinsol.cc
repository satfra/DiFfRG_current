...
TEST_CASE("Test KINSOL with linear system", "[linear]")
{
...
TEST_CASE("Test KINSOL with nonlinear system", "[nonlinear]")
{
...
bool nonlinear_test(FUNf &f, FUNdf &df, VectorType &x0, const VectorType &x_solution)
{
  ...
  DiFfRG::KINSOL<VectorType> newton(1e-14, 1e-12, 1e-1, 21, 21);
