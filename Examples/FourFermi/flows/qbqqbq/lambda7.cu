...
namespace DiFfRG
{
  namespace Flows
  {
    lambda7_integrator::lambda7_integrator(QuadratureProvider &quadrature_provider, std::array<uint, 2> grid_sizes,
    ...
    void lambda7_integrator::set_T(const double value) { integrator->set_T(value); }
    void lambda7_integrator::set_q0_extent(const double value) { integrator->set_q0_extent(value); }
