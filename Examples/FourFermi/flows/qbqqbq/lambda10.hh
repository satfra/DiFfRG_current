...
namespace DiFfRG
{
  namespace Flows
  {
    ...
    {
    public:
      lambda10_integrator(QuadratureProvider &quadrature_provider, std::array<uint, 2> grid_sizes,
                          const double x_extent, const double q0_extent, const uint q0_summands, const ConfigTree &json);
