 ...
 * @file tuning.hh
 *
 * tune_m2A drives the initial gluon mass onto the scaling separatrix, using the critical scaling
 * of Zc(0) as the observable. It is the same search the symmetric-point sibling in ../SP runs;
 * that one additionally nests it inside an STI coupling search.
 *
