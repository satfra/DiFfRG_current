     ...
     sp[p2, p2]^2*(-3*sp[l1, p1]^4 - 6*sp[l1, p1]^3*sp[p1, p1] + 
       ...
       2*sp[p1, p1]^2*(sp[p1, p1]^2 + sp[p1, p2]^2 - 12*sp[p1, p2]*
          sp[p2, p2] + sp[p2, p2]^2 + sp[p1, p1]*(-12*sp[p1, p2] + 
           7*sp[p2, p2])))) + sp[l1, l1]*sp[l1, p1]*sp[l1, p2]*
    (-2*sp[l1, p1]^5*sp[p2, p2]^2 + 2*sp[l1, p1]^4*sp[p2, p2]*
      (2*sp[p1, p1]*sp[p2, p2] + sp[l1, p2]*(2*sp[p1, p2] + sp[p2, p2])) - 
     sp[l1, p1]^3*(sp[l1, p2]*(3*sp[p1, p2]^2 + 4*sp[p1, p1]*
          (2*sp[p1, p2] - 7*sp[p2, p2]))*sp[p2, p2] + 
       2*sp[p1, p1]*(sp[p1, p1] - 9*sp[p2, p2])*sp[p2, p2]^2 + 
       2*sp[l1, p2]^2*(sp[p1, p2]^2 + sp[p1, p1]*sp[p2, p2] + 
         2*sp[p1, p2]*sp[p2, p2])) + 2*sp[p1, p1]^2*
      (sp[l1, p2]^5 + 2*sp[l1, p2]^4*sp[p2, p2] + sp[l1, p2]^3*sp[p2, p2]*
        (-9*sp[p1, p1] + sp[p2, p2]) + 2*sp[l1, p2]*sp[p1, p2]*sp[p2, p2]*
        (sp[p1, p2]^2 - 7*sp[p1, p1]*sp[p2, p2]) + sp[p1, p2]*sp[p2, p2]^2*
        (sp[p1, p2]^2 - 7*sp[p1, p1]*sp[p2, p2]) + 
       sp[l1, p2]^2*(sp[p1, p2]^3 - 3*sp[p1, p1]*sp[p1, p2]*sp[p2, p2] - 
         6*sp[p1, p1]*sp[p2, p2]^2)) + 2*sp[l1, p1]^2*
      (sp[p2, p2]^2*(sp[p1, p2]^3 - 6*sp[p1, p1]^2*sp[p2, p2] - 
     ...
     2*sp[l1, p1]*sp[p1, p1]*(sp[l1, p2]^5*(6*sp[p1, p1] + sp[p1, p2]) + 
      ...
      (sp[l1, p2]^4*(sp[p1, p1]^2 + sp[p1, p2]^2 + sp[p1, p1]*
       ...
       sp[l1, p2]^3*(-24*sp[p1, p1]^2*sp[p2, p2] + 2*sp[p1, p2]^2*
          sp[p2, p2] + 4*sp[p1, p1]*(2*sp[p1, p2]^2 + 3*sp[p1, p2]*
            sp[p2, p2] - sp[p2, p2]^2)) + sp[l1, p2]^2*
        (-2*sp[p1, p1]^3*sp[p2, p2] + sp[p1, p1]^2*(sp[p1, p2]^2 - 
           8*sp[p1, p2]*sp[p2, p2] - 13*sp[p2, p2]^2) + 
         sp[p1, p2]^2*(sp[p1, p2]^2 + sp[p2, p2]^2) - 2*sp[p1, p1]*sp[p2, p2]*
          (11*sp[p1, p2]^2 + 4*sp[p1, p2]*sp[p2, p2] + sp[p2, p2]^2)) + 
       sp[p2, p2]^2*(sp[p1, p2]^4 + 5*sp[p1, p1]^3*sp[p2, p2] - 
         5*sp[p1, p1]*sp[p1, p2]^2*sp[p2, p2] + sp[p1, p1]^2*
          (-2*sp[p1, p2]^2 - 24*sp[p1, p2]*sp[p2, p2] + 5*sp[p2, p2]^2)))) + 
      ...
      (-6*sp[l1, p2]^3*(sp[p1, p2]^2 + sp[p1, p1]*(2*sp[p1, p2] + 
       ...
       sp[p2, p2]^2*(5*sp[p1, p1]^2*sp[p2, p2] + 3*sp[p1, p2]^2*sp[p2, p2] + 
         sp[p1, p1]*(3*sp[p1, p2]^2 - 24*sp[p1, p2]*sp[p2, p2] + 
           5*sp[p2, p2]^2))))))/(FunKit`dressing[FunKit`InverseProp, {A, A}, 
   1, {-l1, l1}]*FunKit`dressing[FunKit`InverseProp, {A, A}, 1, {l1, -l1}]^2*
