...
(2*FunKit`dressing[FunKit`GammaN, {A, A, A}, 1, {-p1, l1 + p1, -l1}]*
  ...
  (-4*sp[l1, l1]^4*sp[p1, p1]^2*sp[p2, p2]^2 + sp[l1, l1]^3*sp[p2, p2]*
    (-3*sp[l1, p2]^2*sp[p1, p1]^2 + 6*sp[l1, p2]*sp[p1, p1]*
      (sp[l1, p1] + 6*sp[p1, p1])*sp[p1, p2] + 
     sp[l1, p1]^2*(-2*sp[p1, p2]^2 + 3*sp[p1, p1]*sp[p2, p2]) + 
     2*sp[l1, p1]*sp[p1, p1]*(-9*sp[p1, p2]^2 + 5*sp[p1, p1]*sp[p2, p2]) - 
   ...
   sp[l1, p1]^2*(sp[l1, p2]^4*sp[p1, p1]^2 - 2*sp[l1, p1]*sp[l1, p2]^3*
     ...
     sp[l1, p2]^2*(2*sp[l1, p1]*sp[p1, p1]*(sp[p1, p2]^2 - 
         2*sp[p1, p1]*sp[p2, p2]) + sp[p1, p1]^2*(sp[p1, p2]^2 - 
         2*sp[p1, p1]*sp[p2, p2]) + sp[l1, p1]^2*(sp[p1, p2]^2 + 
         sp[p1, p1]*sp[p2, p2]))) + sp[l1, l1]*sp[l1, p1]*
    (2*sp[l1, p2]^4*sp[p1, p1]^2 - 4*sp[l1, p1]*sp[l1, p2]^3*sp[p1, p1]*
      sp[p1, p2] - 2*sp[l1, p2]*sp[p1, p2]*(sp[l1, p1]^2*sp[p1, p2]^2 + 
       2*sp[l1, p1]^3*sp[p2, p2] + 2*sp[l1, p1]*sp[p1, p1]*
        (sp[p1, p2]^2 - 3*sp[p1, p1]*sp[p2, p2]) + 
       sp[p1, p1]^2*(sp[p1, p2]^2 - 3*sp[p1, p1]*sp[p2, p2])) + 
     sp[l1, p2]^2*(-18*sp[p1, p1]^3*sp[p2, p2] + 3*sp[l1, p1]*sp[p1, p1]*
