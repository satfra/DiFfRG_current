...
-((FunKit`dressing[FunKit`GammaN, {A, A, A}, 1, {-p1, -l1 + p1, l1}]*
   ...
   FunKit`dressing[FunKit`GammaN, {A, A, A, A}, 1, 
    ...
    sp[l1, l1]^3*(-(sp[l1, p2]^2*sp[p1, p1]*(2*sp[p1, p2]^2 + 
      ...
      sp[p2, p2]*(-(sp[l1, p1]^2*(2*sp[p1, p2]^2 + 5*sp[p1, p1]*
            sp[p2, p2])) - sp[l1, p1]*(-9*sp[p1, p2]^3 + 
          12*sp[p1, p1]^2*sp[p2, p2] + sp[p1, p1]*sp[p1, p2]*
           (22*sp[p1, p2] + 27*sp[p2, p2])) + 2*sp[p1, p1]*
         (8*sp[p1, p1]^2*sp[p2, p2] + sp[p1, p2]^2*(3*sp[p1, p2] + 
            4*sp[p2, p2]) + sp[p1, p1]*(4*sp[p1, p2]^2 + 37*sp[p1, p2]*
     ...
     (sp[l1, p2]^4*sp[p1, p1]^2 + sp[l1, p2]^3*sp[p1, p1]*
      ...
      sp[l1, p2]^2*(sp[l1, p1]^2*(sp[p1, p2]^2 + sp[p1, p1]*sp[p2, p2]) - 
        sp[p1, p1]*(5*sp[p1, p2]^3 + 19*sp[p1, p1]*sp[p1, p2]*sp[p2, p2] + 
          5*sp[p1, p2]^2*sp[p2, p2] + sp[p1, p1]*sp[p2, p2]*
           (17*sp[p1, p1] + 2*sp[p2, p2])) + sp[l1, p1]*(-5*sp[p1, p2]^3 + 
          32*sp[p1, p1]^2*sp[p2, p2] + sp[p1, p1]*sp[p1, p2]*
      ...
      sp[l1, p2]*(-2*sp[l1, p1]^3*sp[p1, p2]*sp[p2, p2] + 
        ...
        sp[l1, p1]^2*(5*sp[p1, p2]^3 + 2*sp[p1, p1]^2*sp[p2, p2] + 
          sp[p1, p1]*(5*sp[p1, p2]^2 + 19*sp[p1, p2]*sp[p2, p2] + 
            17*sp[p2, p2]^2)))) - sp[l1, l1]*(sp[l1, p1]^5*sp[p2, p2]^2 + 
      ...
      sp[p1, p1]*(sp[l1, p2]^5*sp[p1, p1] - sp[p1, p2]*sp[p2, p2]*
        ...
        sp[l1, p2]^2*(5*sp[p1, p2]^3*(-sp[p1, p2] + sp[p2, p2]) + 
          sp[p1, p1]*sp[p1, p2]*(10*sp[p1, p2]^2 - 15*sp[p1, p2]*sp[p2, p2] + 
            9*sp[p2, p2]^2) + sp[p1, p1]^2*(-6*sp[p1, p2]*sp[p2, p2] + 
            28*sp[p2, p2]^2))) + sp[l1, p1]^3*
      ...
      sp[l1, p1]*(sp[l1, p2]^4*sp[p1, p1]*(sp[p1, p1] - 2*sp[p1, p2]) + 
        sp[l1, p2]^3*(-5*sp[p1, p2]^3 + sp[p1, p1]*sp[p1, p2]*
           (9*sp[p1, p2] + 11*sp[p2, p2]) + 4*sp[p1, p1]^2*
           (sp[p1, p2] + 14*sp[p2, p2])) + sp[p1, p2]*sp[p2, p2]*
         (5*sp[p1, p2]^4 + sp[p1, p1]*sp[p1, p2]^2*(5*sp[p1, p2] + 
            27*sp[p2, p2]) + sp[p1, p1]^2*sp[p2, p2]*(9*sp[p1, p2] + 
            98*sp[p2, p2])) + sp[l1, p2]^2*(-17*sp[p1, p1]^3*sp[p2, p2] + 
          sp[p1, p1]^2*(13*sp[p1, p2] - 132*sp[p2, p2])*sp[p2, p2] + 
          5*sp[p1, p2]^3*(sp[p1, p2] + sp[p2, p2]) + sp[p1, p1]*sp[p1, p2]*
        ...
        sp[l1, p2]*(47*sp[p1, p1]^3*sp[p2, p2]^2 - 5*sp[p1, p2]^4*
          ...
          sp[p1, p1]^2*sp[p2, p2]*(-12*sp[p1, p2]^2 - 209*sp[p1, p2]*
             sp[p2, p2] + 47*sp[p2, p2]^2))) + sp[l1, p1]^2*
       (sp[l1, p2]^3*(sp[p1, p2]^2 + sp[p1, p1]*(-2*sp[p1, p2] + 
            sp[p2, p2])) + sp[p2, p2]*(-5*sp[p1, p2]^3*(sp[p1, p2] - 
            2*sp[p2, p2]) + sp[p1, p1]^2*sp[p2, p2]*(9*sp[p1, p2] + 
            28*sp[p2, p2]) + sp[p1, p1]*sp[p1, p2]*(5*sp[p1, p2]^2 - 
            15*sp[p1, p2]*sp[p2, p2] - 6*sp[p2, p2]^2)) + 
        sp[l1, p2]^2*(32*sp[p1, p1]^2*sp[p2, p2] - sp[p1, p2]^2*
           (26*sp[p1, p2] + 9*sp[p2, p2]) + sp[p1, p1]*(-9*sp[p1, p2]^2 + 
            16*sp[p1, p2]*sp[p2, p2] + 32*sp[p2, p2]^2)) + 
        sp[l1, p2]*(sp[p1, p2]^3*(5*sp[p1, p2] - 7*sp[p2, p2]) - 
          sp[p1, p1]^2*sp[p2, p2]*(5*sp[p1, p2] + 132*sp[p2, p2]) + 
    ...
    sp[l1, l1]^2*(sp[l1, p2]^4*sp[p1, p1]^2 + sp[l1, p2]^3*sp[p1, p1]*
      ...
      sp[l1, p2]^2*(sp[l1, p1]^2*(sp[p1, p2]^2 + sp[p1, p1]*sp[p2, p2]) + 
        ...
        sp[p1, p1]*(sp[p1, p2]^2*(14*sp[p1, p2] - 15*sp[p2, p2]) + 
          16*sp[p1, p1]^2*sp[p2, p2] + sp[p1, p1]*(3*sp[p1, p2]^2 - 
      ...
      sp[p2, p2]*(sp[l1, p1]^4*sp[p2, p2] + sp[l1, p1]^3*
         (9*sp[p1, p2]^2 + 13*sp[p1, p1]*sp[p2, p2] + 4*sp[p1, p2]*
          ...
          sp[p1, p1]*(-15*sp[p1, p2]^2 - 14*sp[p1, p2]*sp[p2, p2] + 
            16*sp[p2, p2]^2)) - sp[l1, p1]*
         (sp[p1, p2]^3*(sp[p1, p2] - 5*sp[p2, p2]) + 2*sp[p1, p1]^3*
           sp[p2, p2] + 5*sp[p1, p1]*sp[p1, p2]*(3*sp[p1, p2]^2 + 
            7*sp[p1, p2]*sp[p2, p2] + 3*sp[p2, p2]^2) + 
          sp[p1, p1]^2*(12*sp[p1, p2]^2 + 129*sp[p1, p2]*sp[p2, p2] + 
            28*sp[p2, p2]^2)) + sp[p1, p1]*
         (sp[p1, p2]^3*(sp[p1, p2] + 14*sp[p2, p2]) + 2*sp[p1, p1]^2*
           sp[p2, p2]*(29*sp[p1, p2] + 14*sp[p2, p2]) + sp[p1, p1]*sp[p1, p2]*
           (14*sp[p1, p2]^2 + 15*sp[p1, p2]*sp[p2, p2] + 58*sp[p2, p2]^2))) - 
      sp[l1, p2]*(2*sp[l1, p1]^3*sp[p1, p2]*sp[p2, p2] + 
        ...
        sp[l1, p1]*(sp[p1, p2]^3*(sp[p1, p2] - 7*sp[p2, p2]) + 
          sp[p1, p1]^2*(41*sp[p1, p2] - 29*sp[p2, p2])*sp[p2, p2] + 
  ...
  (FunKit`dressing[FunKit`InverseProp, {A, A}, 1, {-l1, l1}]*
   ...
   (sp[l1, l1] - 2*sp[l1, p2] + sp[p2, p2])*(sp[p1, p2]^4 + 
