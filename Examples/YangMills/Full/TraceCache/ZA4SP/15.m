...
(FunKit`dressing[FunKit`GammaN, {A, cb, c}, 1, {p1, lf1 - p1, -lf1}]*
  ...
  FunKit`dressing[FunKit`GammaN, {A, cb, c}, 1, 
   {-p1 - p2 - p3, lf1 + p2 + p3, -lf1 + p1}]*FunKit`dressing[FunKit`GammaN, 
   {A, cb, c}, 1, {p3, lf1 + p2, -lf1 - p2 - p3}]*
  ...
  (9*cos[p1, lf1]^2*sp[lf1, lf1] - 
   ...
   12*(cos[p1, lf1] + cos[p2, lf1] + 2*cos[p3, lf1])*Sqrt[sp[lf1, lf1]]*
    Sqrt[sp[p, p]] + 3*(6*cos[p1, lf1]^3 + cos[p1, lf1]^2*
      ...
      (47*cos[p2, lf1]^2 + 52*cos[p2, lf1]*cos[p3, lf1] + 3*cos[p3, lf1]^2) + 
     3*(6*cos[p2, lf1]^3 + 11*cos[p2, lf1]^2*cos[p3, lf1] + 
       5*cos[p2, lf1]*cos[p3, lf1]^2 + 2*cos[p3, lf1]^3))*Sqrt[sp[lf1, lf1]]*
    Sqrt[sp[p, p]] + 16*sp[p, p] - 3*cos[p3, lf1]^2*
    (-3*sp[lf1, lf1] + sp[p, p]) - 9*cos[p2, lf1]^2*
    (2*sp[lf1, lf1] + sp[p, p]) + 6*cos[p1, lf1]*cos[p3, lf1]*
    (6*sp[lf1, lf1] + sp[p, p]) - 6*cos[p2, lf1]*cos[p3, lf1]*
    (3*sp[lf1, lf1] + 2*sp[p, p]) + cos[p1, lf1]*cos[p2, lf1]*
    (-18*sp[lf1, lf1] + 34*sp[p, p])))/
