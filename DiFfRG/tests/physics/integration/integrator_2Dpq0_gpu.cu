...
#include <DiFfRG/physics/integration/integrator_2Dpq0_gpu.hh>
...
TEST_CASE("Test 2Dpx0 gpu momentum integrals", "[2Dpx0 integration][quadrature integration]")
{
  ...
  Integrator2Dpq0GPU<double, PolyIntegrand> integrator(quadrature_provider, {{32, 12, 12}}, x_extent, q0_extent);
