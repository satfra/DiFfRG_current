...
-((FunKit`dressing[FunKit`GammaN, {A, A, A}, 1, {-p1, -l1 + p1, l1}]*
   FunKit`dressing[FunKit`GammaN, {A, A, A}, 1, {-p2, -l1 + p1 + p2, 
     l1 - p1}]*FunKit`dressing[FunKit`GammaN, {A, A, A, A}, 1, 
    ...
    sp[l1, l1]^3*(sp[l1, p2]^2*sp[p1, p1]*(2*sp[p1, p2]^2 + 
      ...
      sp[p1, p1]*(9*sp[p1, p2]^4 + 7*sp[p1, p2]^3*sp[p2, p2] - 
        35*sp[p1, p1]*sp[p1, p2]*sp[p2, p2]^2 + 4*sp[p1, p2]^2*sp[p2, p2]*
         ...
         (15*sp[p1, p1] + 16*sp[p2, p2])) + sp[l1, p2]*
       (-2*sp[l1, p1]*(sp[p1, p2]^3 + 2*sp[p1, p1]*sp[p1, p2]*sp[p2, p2]) + 
        sp[p1, p1]*(7*sp[p1, p2]^3 - 33*sp[p1, p1]*sp[p1, p2]*sp[p2, p2] + 
    ...
    sp[l1, l1]^2*(sp[l1, p2]^4*sp[p1, p1]^2 + sp[l1, p1]^4*sp[p2, p2]^2 + 
      ...
      sp[p1, p1]*(23*sp[p1, p1]^3*sp[p2, p2]^2 + 7*sp[p1, p2]^3*
        ...
        sp[p1, p1]^2*sp[p2, p2]*(-48*sp[p1, p2]^2 - 31*sp[p1, p2]*
           sp[p2, p2] + 32*sp[p2, p2]^2) + sp[p1, p1]*sp[p1, p2]*
         (13*sp[p1, p2]^3 - 31*sp[p1, p2]^2*sp[p2, p2] - 
          97*sp[p1, p2]*sp[p2, p2]^2 - 41*sp[p2, p2]^3)) + 
      sp[l1, p1]*(-45*sp[p1, p1]^3*sp[p2, p2]^2 + sp[p1, p1]^2*sp[p2, p2]*
         (110*sp[p1, p2]^2 + 83*sp[p1, p2]*sp[p2, p2] - 36*sp[p2, p2]^2) + 
        sp[p1, p2]^3*(-8*sp[p1, p2]^2 + 8*sp[p1, p2]*sp[p2, p2] + 
          5*sp[p2, p2]^2) - sp[p1, p1]*sp[p1, p2]*(31*sp[p1, p2]^3 - 
          13*sp[p1, p2]^2*sp[p2, p2] + 48*sp[p1, p2]*sp[p2, p2]^2 + 
          15*sp[p2, p2]^3)) + sp[l1, p2]^2*
      ...
      sp[l1, p2]*(2*sp[l1, p1]^3*sp[p1, p2]*sp[p2, p2] + 
        ...
        sp[l1, p1]*(sp[p1, p1]^2*(69*sp[p1, p2] - 29*sp[p2, p2])*sp[p2, p2] + 
          sp[p1, p2]^3*(-17*sp[p1, p2] + 7*sp[p2, p2]) - 
          sp[p1, p1]*sp[p1, p2]*(13*sp[p1, p2]^2 + 58*sp[p1, p2]*sp[p2, p2] + 
            41*sp[p2, p2]^2)) + sp[p1, p1]*
         (sp[p1, p2]^2*(19*sp[p1, p2]^2 + 8*sp[p1, p2]*sp[p2, p2] + 
      ...
      sp[l1, p1]*(sp[l1, p2]^4*sp[p1, p1]*(3*sp[p1, p1] - 2*sp[p1, p2]) + 
        45*sp[p1, p1]^4*sp[p2, p2]^2 + 5*sp[p1, p2]^5*(sp[p1, p2] + 
          sp[p2, p2]) + sp[p1, p1]*sp[p1, p2]^3*(27*sp[p1, p2]^2 + 
        ...
        sp[l1, p2]^3*(-5*sp[p1, p2]^3 + 11*sp[p1, p1]*sp[p1, p2]*
           (3*sp[p1, p2] + sp[p2, p2]) - 2*sp[p1, p1]^2*(8*sp[p1, p2] + 
            3*sp[p2, p2])) + sp[l1, p2]^2*(50*sp[p1, p1]^3*sp[p2, p2] + 
          5*sp[p1, p2]^3*(2*sp[p1, p2] + sp[p2, p2]) + sp[p1, p1]*sp[p1, p2]*
           (-36*sp[p1, p2]^2 + 27*sp[p1, p2]*sp[p2, p2] - 5*sp[p2, p2]^2) + 
          sp[p1, p1]^2*(-7*sp[p1, p2]^2 - 17*sp[p1, p2]*sp[p2, p2] + 
            28*sp[p2, p2]^2)) - sp[l1, p2]*
         (5*sp[p1, p2]^4*(2*sp[p1, p2] + sp[p2, p2]) + sp[p1, p1]^3*
           sp[p2, p2]*(11*sp[p1, p2] + 97*sp[p2, p2]) + 
      ...
      sp[p1, p1]*(sp[l1, p2]^5*sp[p1, p1] - sp[l1, p2]^4*
        ...
        sp[p1, p1]*sp[p1, p2]^3*(9*sp[p1, p2]^2 + 16*sp[p1, p2]*sp[p2, p2] + 
          ...
          9*sp[p2, p2]^3) + sp[l1, p2]^3*(3*sp[p1, p1]^2*(2*sp[p1, p2] + 
            sp[p2, p2]) - 5*sp[p1, p2]^2*(2*sp[p1, p2] + sp[p2, p2]) + 
         ...
         (5*sp[p1, p2]^4*(2*sp[p1, p2] + sp[p2, p2]) + sp[p1, p1]^3*
           sp[p2, p2]*(3*sp[p1, p2] + 50*sp[p2, p2]) + 
